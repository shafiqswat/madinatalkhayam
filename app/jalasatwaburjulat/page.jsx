...
export default function Page() {
  ...
  // Filter posts that contain "جلسات" or "برجولات" in the title or span
  const filteredPosts = posts.filter(
    (post) =>
      post.title.includes("جلسات") ||
      post.title.includes("برجولات") ||
      post.span.includes("جلسات") ||
      post.span.includes("برجولات")
  );

  return (
    <main>
      <h1 style={{ display: "none" }}>مظلات جلسات وبرجولات</h1>
      {loading ? (
        <>
