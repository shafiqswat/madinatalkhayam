...
export default function Page() {
  ...
  // Filter posts that contain "هناجر" in the title or span
  const filteredPosts = posts.filter(
    (post) => post.title.includes("هناجر") || post.span.includes("هناجر")
  );

  return (
    <main>
      <h1 style={{ display: "none" }}>هناجر القصيم بريده عنيزه</h1>
      {loading ? (
        <>
